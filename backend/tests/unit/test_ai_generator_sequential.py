...
class TestAIGeneratorSequential:
    ...
    def test_sequential_tool_calling_two_rounds(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
        ...
        final_response.content[0].text = "Based on the course overview and search results, here's the answer about Python variables."
        ...
        mock_tool_manager.execute_tool.assert_any_call("get_course_overview", course_name="Python Basics")
        ...
        assert result == "Based on the course overview and search results, here's the answer about Python variables."

    def test_sequential_tool_calling_early_termination(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
    ...
    def test_sequential_tool_calling_with_conversation_history(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
        ...
        mock_tool_manager.execute_tool.return_value = "Advanced topics: decorators, generators, context managers"
    ...
    def test_sequential_tool_calling_max_rounds_limit(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
        ...
        mock_anthropic_client.messages.create.side_effect = [tool_response, tool_response, final_response]
    ...
    def test_sequential_tool_calling_conversation_state_management(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
    ...
    def test_sequential_tool_calling_mixed_content_handling(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
    ...
    def test_sequential_tool_calling_error_recovery(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
        ...
        final_response = Mock()
        final_response.content = [Mock()]
        final_response.content[0].text = "I encountered an error but here's alternative information."
        
        mock_anthropic_client.messages.create.side_effect = [first_response, final_response]
        
        # Mock tool execution to raise an exception
        mock_tool_manager.execute_tool.side_effect = Exception("Search service unavailable")
    ...
    def test_sequential_tool_calling_complex_workflow(self, ai_generator, mock_anthropic_client, mock_tool_manager, sample_tools):
        ...
        final_response = Mock()
        final_response.content = [Mock()]
        final_response.content[0].text = "Based on the course overview and specific content search, here's comprehensive information about Python functions and classes."
        ...
        assert result == "Based on the course overview and specific content search, here's comprehensive information about Python functions and classes."