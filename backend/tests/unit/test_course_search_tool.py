...
class TestCourseSearchTool:
    ...
    @pytest.mark.parametrize(
        "course_name,lesson_number,expected",
        [
            ...
            (
                "Test Course",
                1,
                "No relevant content found in course 'Test Course' in lesson 1.",
            ),
        ],
    )
    def test_execute_empty_results_with_filters(
        self, search_tool, mock_vector_store, course_name, lesson_number, expected
    ):
        ...
        result = search_tool.execute(
            "topic", course_name=course_name, lesson_number=lesson_number
        )
    ...
    def test_execute_results_without_lesson_number(
    ...
    def test_source_tracking_with_multiple_calls(self, search_tool, mock_vector_store):
        ...
        mock_results1 = SearchResults(
            ...
            metadata=[
                {"course_title": "Course 1", "lesson_number": 1, "chunk_index": 0}
            ],
            distances=[0.1],
            error=None,
        )
        mock_results2 = SearchResults(
            ...
            metadata=[
                {"course_title": "Course 2", "lesson_number": 2, "chunk_index": 0}
            ],
            distances=[0.1],
            error=None,
        )
